...
<html>
    <head>
        <title>ORIGAM Documentation : Filesystem Functions</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
            <div id="main" class="aui-page-panel">
                <div id="main-header">
                    ...
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : Filesystem Functions
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Petr Hrehorovský</span>, last modified on May 16, 2016
                        </div>
                    <div id="main-content" class="wiki-content group">
                    <p>Filesystem related functions.<h3><a href="FileExists_10453010.html">FileExists</a></h3>
<p>Returns true if file exists on the given path.</p>
</p>
                    </div>
