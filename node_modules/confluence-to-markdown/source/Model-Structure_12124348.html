...
<html>
    <head>
        <title>ORIGAM Documentation : Model Structure</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
            <div id="main" class="aui-page-panel">
                <div id="main-header">
                    ...
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : Model Structure
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Zuzana Čapková</span>, last modified on Feb 05, 2019
                        </div>
