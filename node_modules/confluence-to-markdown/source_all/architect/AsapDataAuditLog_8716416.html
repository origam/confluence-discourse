...
<html>
    <head>
        <title>ORIGAM Documentation : AsapDataAuditLog</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
                        ...
                        <ol id="breadcrumbs">
                            <li class="first">
                                ...
                                <span><a href="Entities_1736806.html">Entities</a></span>
                                                    ...
                                                    <li>
                                <span><a href="Predefined-Entities_7831935.html">Predefined Entities</a></span>
                            </li>
                                                </ol>
                    </div>
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : AsapDataAuditLog
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Tomáš Vavrda</span>, last modified on Dec 20, 2016
                        </div>
                    <div id="main-content" class="wiki-content group">
                    <p>See <a href="Data-Audit-Log_5668875.html">Data Audit Log</a>.</p>
                    </div>
