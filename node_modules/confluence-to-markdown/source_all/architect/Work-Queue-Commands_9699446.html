...
<html>
    <head>
        <title>ORIGAM Documentation : Work Queue Commands</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
            <div id="main" class="aui-page-panel">
                <div id="main-header">
                    ...
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : Work Queue Commands
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Tomáš Vavrda</span> on Nov 18, 2015
                        </div>
                    <div id="main-content" class="wiki-content group">
                    <p>A command is an action that can be executed on a work queue message. It can be either a built-in action (move to queue, change record's value) or a custom action based on a sequential workflow.</p><p> </p>
                    </div>
