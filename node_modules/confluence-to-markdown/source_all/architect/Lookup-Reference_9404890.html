...
<html>
    <head>
        <title>ORIGAM Documentation : Lookup Reference</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
            <div id="main" class="aui-page-panel">
                <div id="main-header">
                    ...
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : Lookup Reference
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Tomáš Vavrda</span>, last modified by <span class='editor'> Zuzana Čapková</span> on Feb 18, 2019
                        </div>
