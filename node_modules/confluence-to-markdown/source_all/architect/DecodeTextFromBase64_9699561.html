...
<html>
    <head>
        <title>ORIGAM Documentation : DecodeTextFromBase64</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
            <div id="main" class="aui-page-panel">
                <div id="main-header">
                    ...
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : DecodeTextFromBase64
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Filip Tvrdoň</span> on Feb 22, 2016
                        </div>
