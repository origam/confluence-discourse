...
<html>
    <head>
        <title>ORIGAM Documentation : Template Set Template</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
                        ...
                        <ol id="breadcrumbs">
                            <li class="first">
                                ...
                                <span><a href="Data-Structures_1736808.html">Data Structures</a></span>
                                                    ...
                                                    <li>
                                <span><a href="Template-Sets_9404857.html">Template Sets</a></span>
                            </li>
                                                </ol>
                    </div>
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : Template Set Template
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Tomáš Vavrda</span> on Jul 09, 2015
                        </div>
