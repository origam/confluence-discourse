...
<html>
    <head>
        <title>ORIGAM Documentation : Template Sets</title>
    ...
    <body class="theme-default aui-theme-default">
        <div id="page">
            <div id="main" class="aui-page-panel">
                <div id="main-header">
                    ...
                    <h1 id="title-heading" class="pagetitle">
                                                <span id="title-text">
                            ORIGAM Documentation : Template Sets
                        </span>
                    </h1>
                </div>
            ...
            Created by <span class='author'> Tomáš Vavrda</span>, last modified on Jul 09, 2015
                        </div>
